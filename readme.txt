...
git config --global user.name "HamdaniFatima"
git config --global user.email hanane33hanine@gmail.com
...
1/ pwd
 2/ git clone https://github.com/HamdaniFatima/Stories
 3/  mkvirtualenv --python=/usr/bin/python3.8  myenv
